    ...
    if (!raw) {
      ...
      entries[yesterdayKey] = {
        ...
        morning: {
          ...
          makesGreat: [
            'Сделать один важный шаг в деле, которое откладывал',
            'Выйти на 20-минутную прогулку без спешки и телефона',
            'Приготовить вкусный теплый чай и уделить время себе'
          ],
          affirmation: 'Я имею право делать что-то не идеально и беречь свои силы.',
          completed: true,
          completedAt: '08:15',
        },
        evening: {
          goodDeed: 'Вовремя остановился отдохнуть, честно выразил свои чувства и позаботился о себе',
          improvement: 'Понял, что мне нужна тишина после насыщенного дня, а не еще больше задач',
          greatMoments: [
            'Сказал себе спасибо за спокойствие в непростом разговоре',
            'Теплый свет заката над осенним городом',
            'Уютное чтение книги перед сном в полной тишине'
          ],
          mood: 5,
          completed: true,
          completedAt: '22:10',
